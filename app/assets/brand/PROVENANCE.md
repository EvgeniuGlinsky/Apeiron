...
воспроизводимости и для сверки), а в приложение идёт **переработанная** производная: изменены
пропорции, разворот и посадка крыльев. CC0 производные разрешает без ограничений.
